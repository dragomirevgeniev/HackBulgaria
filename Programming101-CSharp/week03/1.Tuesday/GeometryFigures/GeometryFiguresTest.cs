...
{
    class GeometryFiguresTest
    {
        static void Main(string[] args)
        {
            Point p1 = new Point(2.5, 2.1);
            Point p2 = new Point(4.5, 0.5);
            Console.WriteLine("{0} + {1} = {2}", p1, p2, p1 + p2);
            Console.WriteLine();

            LineSegment ls1 = new LineSegment(new Point(1, 1), new Point(1, 4));
            LineSegment ls2 = new LineSegment(new Point(2, 3), new Point(4, 6));
            ...
            Vector v1 = new Vector(1, 3, 5, 4);
            Vector v2 = new Vector(2, 7, 8, 6);
